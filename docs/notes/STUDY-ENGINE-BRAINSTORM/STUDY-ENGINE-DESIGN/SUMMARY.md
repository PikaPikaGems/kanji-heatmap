...
someone who needs to know what StudyEngine is, what it exposes, how the app will
use it, what happens under the hood, and what the data looks like — without
reading the specifications that own each of those.
