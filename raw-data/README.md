...
| `radicals.json`                                                                                                                                                                                                                                                                                                          | Groupings, lookalike aliases, and search redirects. Merged with `radical-aliases.json` into `public/json/v2/radicals.json`. Keywords still feed `components.json`. |
| `radical-aliases.json`                                                                                                                                                                                                                                                                                                   | Extra lookalike mappings merged into the generated radicals file                                                                                                   |
