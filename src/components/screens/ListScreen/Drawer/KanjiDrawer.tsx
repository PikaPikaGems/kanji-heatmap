...
export function KanjiDrawerRaw({
  ...
  return (
    <Drawer open={isOpen} onClose={onClose} autoFocus={true}>
      <DrawerContent className="!select-text h-[calc(100dvh_-_50px)] !duration-200 border-2 border-t-4 [border-top-style:dashed]">
        ...
        <DrawerClose asChild className="absolute top-2 right-2">
          <Button variant="ghost" size="icon" className="p-4 border-2 border-dashed rounded-xl bg-background z-1000!">
